<div id="sidebar" class="js-target-sidebar"> <h2 class="c-side-menu__title">{{Auth::user()->name}}さん</h2>
    <ul class="c-side-menu">
        ...
        <li class="c-side-menu__list"><i class="fas fa-user-slash u-mr-2"></i><a href="{{route('mypage.account')}}" class="c-side-menu__link">アカウント削除</a></li>
        <li class="c-side-menu__list"><i class="fas fa-cog u-mr-2"></i><a href="{{route('mypage.setting')}}" class="c-side-menu__link">設定</a></li>
